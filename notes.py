...
defпостроения пользовательского интерфейса и взаимодействия с пользователем, вы можете использовать модуль argparse для обработки командной строки или просто использовать простой цикл ввода-вывода, чтобы запрашивать пользовательские команды и данные.
